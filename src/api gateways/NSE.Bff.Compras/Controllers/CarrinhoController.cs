...
namespace NSE.Bff.Compras.Controllers
{
    ...
    public class CarrinhoController : MainController
    {
        ...
        private async Task ValidarItemCarrinho(ItemProdutoDTO produto, int quantidade)
        {
            ...
            {
                AdicionarErroProcessamento($"O produto {produto.Nome} possui {produto.QuantidadeEstoque} unidades em estoque, voce selecionoi {quantidade}");
                return;
            }

            if (quantidade > produto.QuantidadeEstoque) AdicionarErroProcessamento($"O produto {produto.Nome} possui {produto.QuantidadeEstoque} unidades em estoque");
        }
    }
}
