...
namespace NSE.Pedidos.API.Controllers
{
    public class PedidoController : MainController
    {
        ...
        {
            pedido.ClienteId = _user.ObterUserdId();
        ...
        {
            var pedido = await _pedidoQueries.ObterUltimoPedido(_user.ObterUserdId());
        ...
        {
            var pedidos = await _pedidoQueries.ObterListaPorClienteId(_user.ObterUserdId());
