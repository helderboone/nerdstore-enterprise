...
namespace NSE.Pedidos.API.Application.Commands
{
    public class AdicionarPedidoCommand : Command
    {
        ...
        {
            ValidationResult = new AdicionarPedidoValication().Validate(this);
            return ValidationResult.IsValid;
        }

        public class AdicionarPedidoValication : AbstractValidator<AdicionarPedidoCommand>
        {
            public AdicionarPedidoValication()
            {
                ...
                RuleFor(c => c.PedidoItems.Count)
                    .GreaterThan(0)
                    .WithMessage("O pedido precisa ter no mínimo dois itens");
